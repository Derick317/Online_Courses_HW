...
class PGAgent(BaseAgent):
    ...
    def calculate_q_vals(self, rewards_list):
        ...
        # HINT1: rewards_list is a list of numpy.arrays of rewards. Each inner array
            # is an array of rewards for a single trajectory.
    ...
    def estimate_advantage(self, obs, rews_list, q_values, terminals):
        ...
        if self.nn_baseline:
            ...
            assert values_unnormalized.ndim == q_values.ndim, "The value predictions and q_values have different dimensionalities!"
            ...
            if self.gae_lambda is not None:
                ...
                for i in reversed(range(batch_size)):
                    ...
                    if terminals[i] == 1:
                        ...
                        advantages[i] = rews[i] + self.gamma * values[i + 1] - values[i] + self.gae_lambda * self.gamma * advantages[i + 1]

                # remove dummy advantage
                advantages = advantages[:-1] #TODO
    ...
    def _discounted_return(self, rewards):
        ...
        list_of_discounted_returns = [rewards @ self.gamma ** np.array(range(len(rewards)))]*len(rewards)
    ...
    def _discounted_cumsum(self, rewards):
        ...
        list_of_discounted_cumsums = list(rewards)
        for i in range(len(rewards)-1):
            i = len(rewards) - i - 2
            list_of_discounted_cumsums[i] = list_of_discounted_cumsums[i+1] * self.gamma + rewards[i]
